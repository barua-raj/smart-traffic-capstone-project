...
<head>
  ...
  <title>Vehicle List</title><link rel="icon" href="../img/favicon2.png">
            ...
            <div class="box-body">
              ...
              <table id="example" class="display" >
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM  vehicle_registration_brta ORDER By id DESC";
                  $result = $conn->query($sql);

                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> <a href='vehicledetails.php?update=". $row["id"]."'>" . $row["Registration_No"]."</a> </td><td><a href='vehicledetails.php?update=". $row["id"]."'>" . $row["Vehicle_class"]. "</a></td><td> <a href='vehicledetails.php?update=". $row["id"]."'>" . $row["NID_No"]. "</a> </td><td> <a href='vehicledetails.php?update=". $row["id"]."'>" . $row["Engine_No"]. "</a> </td><td> <a href='vehicledetails.php?update=". $row["id"]."'>" . $row["Chassis_No"]. "</a></tr>";
                       }
                                  }
