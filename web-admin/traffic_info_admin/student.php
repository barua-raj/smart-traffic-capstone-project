...
<!-- general form elements -->
            ...
            <form role="form" method="POST" >
              <div class="box-body">
                ...
                <div class="input-group date">
                  ...
                  <input type="hidden" name='dob' class="form-control pull-right" id="datepicker" value="test" placeholder="Select Student's Data of Birth">
                </div>
                <!-- /.input group -->
 ...
 <div class="form-group">
                  ...
                  <input name="password" type="password" class="form-control" id="exampleInputPassword1" placeholder="Enter Student Password" required>
                </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> " . $row["sid"]. " </td><td> " . $row["fname"]." ". $row["lname"]. " </td><td>" . $row["department_name"]. "</td><td>" . $row["semester_name"]. "</td><td><a href='student.php?update=". $row["sid"]."'><small class='label  bg-orange'>Update</small></a></td></tr>";
                       }
                                  }
