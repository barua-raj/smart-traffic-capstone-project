...
<head>
  ...
  <title>License List</title><link rel="icon" href="../img/favicon2.png">
...
x.style.display='block';</script>";
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">All License List</h3>
            </div>
            ...
            <div class="box-body">
              ...
              <table id="example" class="display" >
                ...
                <tbody>
                  ...
                  $sql = "SELECT * FROM  driving_license ORDER By id DESC";
                  $result = $conn->query($sql);

                  if ($result->num_rows > 0) {
                   // output data of each row
                     while($row = $result->fetch_assoc()) {
                      echo "<tr><td> <a href='license_details.php?update=". $row["id"]."'>" . $row["ref_no"]."</a> </td><td><a href='license_details.php?update=". $row["id"]."'>" . $row["dctb_serial"]. "</a></td><td> <a href='license_details.php?update=". $row["id"]."'>" . $row["type_of_license"]. "</a> </td><td> <a href='license_details.php?update=". $row["id"]."'>" . $row["name"]. "</a> </td><td> <a href='license_details.php?update=". $row["id"]."'>" . $row["NID_No"]. "</a></tr>";
                       }
                                  }
