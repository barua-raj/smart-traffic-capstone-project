...
public class GetDriverInfo extends AppCompatActivity {
    EditText search;
    RecyclerView recyclerView;
    ProgressBar progressBar;
    OwnerAddDriverModel adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_driver_info);
    ...
    public void getDataa(String nid){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(GetDriverInfo.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter = new OwnerAddDriverModel(modelList,GetDriverInfo.this);
                    recyclerView.setAdapter(adapter);
    ...
    public void getData(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(GetDriverInfo.this, "Error", Toast.LENGTH_SHORT).show();
            }
        }
        );
