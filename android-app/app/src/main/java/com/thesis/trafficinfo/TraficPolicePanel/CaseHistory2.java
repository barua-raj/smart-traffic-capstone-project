...
public class CaseHistory2 extends AppCompatActivity {
    String nid,vehicle_reg;
    EditText search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_case_history2);
    ...
    public void getDataa(){
        ...
        String url=BASE_URL+"getHistory2.php?Vehicle_number="+vehicle_reg;
        RequestQueue requestQueue = Volley.newRequestQueue(CaseHistory2.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter = new History_Adapter(modelList,CaseHistory2.this);
                    recyclerView.setAdapter(adapter);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                stringStringMap.put("Vehicle_number",  vehicle_reg);
