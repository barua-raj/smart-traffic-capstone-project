...
//                    applicantTypeET.setText(data.getString("Role"));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(vehicle_details.this, "Check Internet Connection", Toast.LENGTH_SHORT).show();
    ...
    public void checkhistory(View view) {
        ...
        Intent intent = new Intent(vehicle_details.this,CaseHistory2.class);
    ...
    public void checkdues(View view) {
        Intent intent = new Intent(vehicle_details.this, CheckDues.class);
        intent.putExtra("vehicle_reg",reg);
        startActivity(intent);
