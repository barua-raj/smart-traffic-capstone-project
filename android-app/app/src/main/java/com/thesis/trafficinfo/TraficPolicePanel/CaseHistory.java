...
public class CaseHistory extends AppCompatActivity {
    ...
    public void getDataa(){
        ...
        String url=BASE_URL+"getHistory.php?NID_No="+nid;
        RequestQueue requestQueue = Volley.newRequestQueue(CaseHistory.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    adapter = new History_Adapter(modelList,CaseHistory.this);
                    recyclerView.setAdapter(adapter);
