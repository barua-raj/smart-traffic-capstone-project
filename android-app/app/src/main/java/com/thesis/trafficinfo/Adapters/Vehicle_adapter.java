...
public class Vehicle_adapter extends RecyclerView.Adapter<Vehicle_adapter.ViewHolder> {
    ...
    public Vehicle_adapter(List<vehicles> modelList, Context context) {
        this.modelList = modelList;
        this.context = context;
    }
    public void filteredList(ArrayList<vehicles> modelArrayList) //search result er jnno
    {
    ...
    public Vehicle_adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Vehicle_adapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate( R.layout.vehicle_row,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull Vehicle_adapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent  = new Intent(context, CaseByVehicle.class);
